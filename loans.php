...
<p class="fs-1 text-center">Loan Details</p>
<div class="container-fluid">
  <div class="row">
    <div class="col-2">
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  ...
  <div class="card text-white bg-primary mb-3">
    ...
    <p class="card-text">View your Current loan balance</p>
  ...
  <div class="card text-white bg-primary mb-3">
    ...
    <p class="card-text">Apply for a New loan</p>
  ...
  <div class="card text-white bg-success mb-3">
    <div class="card-body">
    <h5 class="card-title">Guarantorship</h5>
    <p class="card-text">Accept/Reject Guarantorship</p>
    <a href="guarant.php" class="btn btn-outline-light">View</a>
    </div>
    </div>
  </div>
</div>
