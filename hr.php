...
<p class="fs-1 text-center">Human Resource Module</p>
<div class="container-fluid">
  <div class="row">
    <div class="col-2">
...
<div class="row row-cols-1 row-cols-md-2 g-4">
  ...
  <div class="card text-white bg-success mb-3">
    ...
    <p class="card-text">View the leave Application form</p>
    <a href="hrleave.php" class="btn btn-outline-light">Apply</a>
    </div>
    </div>
  </div>
  <div class="col-5">
  <div class="card text-white bg-primary mb-3">
    <div class="card-body">
    <h5 class="card-title">View Leave Application</h5>
    <p class="card-text">Manage Leave Application</p>
    <a href="hrmleave.php" class="btn btn-outline-light">View</a>
    </div>
    </div>
  </div>
  </div>
