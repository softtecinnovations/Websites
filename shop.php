...
<body>
	...
	<div class="p-5 mb-4 bg-info rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold text-center">GET THE BEST CLOTHES CHEAP</h1>
            <p class="fs-4 text-center">Welcome to the best place to get quality clothes at affordable prices. Quality and Elegance.</p>
        </div>
	</div>
	<div class="container-fluid">
		<div class="row">
			<div class="col-2">
                ...
                try{
                  ...
                  foreach($stmt as $row){
                    echo "
                      <a href='shop.php?category=".$row['cat_slug']."' class='list-group-item list-group-item-action'>".$row['name']."</a>
                    ";                  
                  }
                }
                catch(PDOException $e){
						    	...
						    	$image = (!empty($row['photo'])) ? 'images/'.$row['photo'] : 'images/noimage.jpg';
	       						echo "
									   ...
									   <div class='card bg-light text-dark border-0'>
												   ...
												   <a href='product.php' class='btn btn-outline-info'>View</a>
												   </div>
	       								</div>
	       							</div>
