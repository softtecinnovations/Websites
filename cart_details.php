			...
			foreach($stmt as $row){
				...
				$output .= "
					...
					<td class='input-group'>
						...
						<td><button type='button' data-id='".$row['cartid']."' class='btn-close' aria-label='Close'></button></td>
					</tr>
				";
			}
			$output .= "
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					...
					<td>&#36; ".number_format($product['price'], 2)."</td>
						...
						<td><button type='button' data-id='".$row['productid']."' class='btn-close' aria-label='Close'></button></td>
						<td>&#36; ".number_format($subtotal, 2)."</td>
					</tr>
				";
