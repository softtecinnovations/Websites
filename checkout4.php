...
<body style="padding-top: 60px;">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-8">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Payment Method</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-4">
                                        <label for="inputPassword4" class="form-label">CVC/CVV</label>
                                        <input type="text" class="form-control" id="inputPassword4">
                                    </div>
                                    <div class="col-4">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Pay with Mpesa</div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Pay on Delivery</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a type="button" class="btn btn-outline-primary" href="checkout3.html">Go Back</a>
        <a type="button" class="btn btn-outline-secondary" href="checkout5.html">Order Review</a>
    </div>
