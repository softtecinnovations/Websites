...
<body style="padding-top: 60px;">
    ...
    <div class="p-5 mb-4 bg-info rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold text-center">ORDER CONFIRMED</h1>
        </div>
    </div>
    <div class="container-fluid align-content-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-check-circle-fill rounded mx-auto d-block" viewBox="0 0 16 16">
            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
          </svg>
        <p class="fs-2 text-center">Thank you, Julie. Your order is confirmed.</p>
        <p class="fs-6 text-center">Your order hasn't shipped yet but we will send you an email when it does.</p>
        <div class="d-grid gap-2 col-4 mx-auto">
            <a href="order.html" class="btn btn-outline-dark btn-default" role="button">MANAGE ORDER</a>
        </div>
    </div>
