...
<body style="padding-top: 60px;">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-8">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="checkout2.html">Address</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Delivery Method</a>
                    </li>
                    <li class="nav-item">
        ...
        <a type="button" class="btn btn-outline-primary" href="checkout.html">Go Back</a>
        <a type="button" class="btn btn-outline-secondary" href="checkout3.html">Delivery Method</a>
    </div>
