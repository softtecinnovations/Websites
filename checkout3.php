...
<body style="padding-top: 60px;">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-whiteshadow-lg p-3 mb-5 rounded">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-8">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page">Delivery Method</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Payment Method</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Order Review</a>
                    </li>
                </ul>
                <ul class="list-group list-group-horizontal list-group-flush flex-fill">
                    <li class="list-group-item">
                        <input class="form-check-input me-1" type="checkbox" value="" aria-label="..."> USPS NEXT DAY</li>
                    <li class="list-group-item">
                        <input class="form-check-input me-1" type="checkbox" value="" aria-label="..."> USPS NEXT DAY</li>
                </ul>
                <ul class="list-group list-group-horizontal list-group-flush flex-fill">
        ...
        <a type="button" class="btn btn-outline-primary" href="checkout1.html">Go Back</a>
        <a type="button" class="btn btn-outline-secondary" href="checkout4.html">Delivery Method</a>
    </div>
